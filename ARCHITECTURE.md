...
- Go modules and build cache are used for efficient builds.
...
- All actions in the workflow are pinned to full commit SHAs for supply chain security.
...
- All build artifacts, SBOMs, and security reports are uploaded as workflow artifacts for traceability and audit.
